...
- **asset tables in protein_index2.db**: Generated by executing `./Uniprot-LLM/config/setUpDatabase.py`.
- **protein_embeddings.ann and protein_index2.db**: Generated by executing `./Uniprot-LLM/config/implementVectorDatabase.py`.
